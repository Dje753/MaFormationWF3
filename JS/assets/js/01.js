...
/*
    Ici je peux faure un commentaire
...
|                                                        |
|   Les variables déclarer directement à la racine       |
...
|   ###                                                  |
|                                                        |
|   Les variables qui sont déclarer a l'interieure       |
|   d'une fonction sont appelées variables LOCALES.      |
|                                                        |   
|   ###                                                  |
|                                                        |
|   Depuis ECME6, vous pouvez déclarer une variable      |
|  avec le mot-clé "let".                                |
|                                                        |
|   Votre variable sera alors accessible uniquement      |
|    dasn le bloc dans lequel est contenu cad déclarer.  |
|                                                        |
...
// -- La fonction parseInt() pour retourner un entier à partir de
...
// -- Conversion d'un noumbre en STRING aevc toString()
